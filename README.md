...
从 UE/Unity/Blender 多项目的真实游戏开发实践中提炼出的多智能体协作体系。已从 [代码工坊](https://github.com/JosephLE910/CodeWorkshop) 独立为可复用公开仓库。

## 这是什么

把"规划者 / 执行者 / 人"三方协作的整套 AI 开发流程抽象成一份**可复用蓝图**——方法论来自跨引擎游戏开发实战，新项目拷贝即可复用，不绑定特定 AI 工具或引擎。
